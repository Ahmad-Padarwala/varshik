...
const AddIncomeCategory = () => {
    ...
    const savedata = async (e) => {
        ...
        console.log(team);
        try {
            await axios.post(`${process.env.REACT_APP_PROXY}/addincomecategory`, team).then((res) => {
                console.log(res);
    ...
    const deleteIncomeCategory = async () => {
        try {
            ...
            const res = await axios.delete(`${process.env.REACT_APP_PROXY}/deleteincomecategory/${catId}`);
