    ...
    <>
      ...
      <section className="dashboard">
        <div className="dash-content  pt-3">
          <div
            className="flex justify-content-between bg-light my-0 py-2 px-3"
            id="hidden"
          >
            {/*All Member Title*/}
            ...
            <div className="center m-0 ">
              <div className="input-group mb-1 ">
                ...
                <div className="input-group-prepend">
                  <i
                    className="uil uil-search input-group-text"
          ...
          <div className="activity ">
            <div>
              {/* clan detail */}
              <div
                className="flex justify-content-start align-items-center py-2"
                Style="background-color:#ffe4c414"
              >
                <div>
                  <span className="key label">Clan Id:</span>
                  <span>{selectedClanId}</span>
                  <span className="key label">Clan Name:</span>
            ...
            <table id="my-table" className="table table-striped mt-2">
              <thead>
          ...
          <div className="row">
            ...
            <div className="col-lg-2 pagination" id="hidden">
              <button
